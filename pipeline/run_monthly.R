...
# v2.2.2 Vision (with preprocess) + strict month/year + per-image OpenAI fallback + manual overrides + debug
...
cli::cli_h1(">> run_monthly v2.2.2 (Vision+preprocess + strict month/year + per-image OpenAI fallback)")
